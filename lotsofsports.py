...
sport1 = Sport(id = 1, name = "Basketball", picture = 'http://ecx.images-amazon.com/images/I/81fi%2BmmwnaL.jpg')
session.add(sport1)
session.commit()

#Create positions in basketball
positionPG = Position(id = 1, name = "PG", sport_id = 1)
session.add(positionPG)
session.commit()

positionSG = Position(id = 2, name = "SG", sport_id = 1)
session.add(positionSG)
session.commit()

positionSF = Position(id =3, name = "SF", sport_id = 1)
session.add(positionSF)
session.commit()

positionPF = Position(id =  4, name = "PF", sport_id = 1)
session.add(positionPF)
session.commit()

positionC = Position(id = 5, name = "C", sport_id = 1)
